# the MCP Server Integration guide for Gemini CLI
...
MCP servers act as a bridge between the Gemini model
...
```json
{
  "mcpServers": {
    "robo_mcp": {
      ...
      "args": [
        "-m",
        "robo_mcp.servers.robo_server"
      ],
      "cwd": "/home/seoyc/Project/work/utils/robo_mcp",
      "env": {}
    }
  }
}    
